    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money_spent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('max_price', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('car', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='common.carmodel')),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='purchase_list',
            field=models.ManyToManyField(through='customer.CustomerPurchase', to='showroom.showroommodel'),
        ),
        migrations.AddField(
            model_name='customermodel',
